		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Le Bhari Khana",
									"targetURL": "#LeBhariKhana-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"LeBhariKhana-display": {
								"semanticObject": "LeBhariKhana",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.bhakar.bhakar",
									"url": sap.ui.require.toUrl("com/bhakar/bhakar")
								}
							}
						}
					}
