sap.ui.define(
	...
	function (BaseController, JSONModel, formatter, Filter, FilterOperator) {
		...
		return BaseController.extend(
			"ui.newell.PrecisionMaterial.controller.Worklist", {
				formatter: formatter,
				...
				onInit: function () {
					...
					var oSmartTable = this.byId("idSearchTable");
					...
					// 		this
					// 	);
					this._oRouter.getRoute("worklist").attachMatched(this._handleRoutePatternMatched, this);
				...
				_handleRoutePatternMatched: function (oEvent) {
					try {
						...
						var oSmartTable = this.getView().byId("idSearchTable");
				...
				onSearch: function (oEvent) {
					if (oEvent.getParameters().refreshButtonPressed) {
						...
						if (sQuery && sQuery.length > 0) {
							aTableSearchState = [
								new Filter("PeDesc", FilterOperator.Contains, sQuery),
							];
						}
				...
				_showObject: function (oItem) {
					this.getRouter().navTo("object", {
						objectId: oItem.getBindingContext().getProperty("DocumentNumber"),
					});
				},
				...
				handleNavToCreateScreen: function () {
					// if (!this.oConfirmationDialog) {
					//   this.oConfirmationDialog = sap.ui.xmlfragment(
					//     "idConfDialog",
					//     "ui.newell.PrecisionMaterial.fragments.RequestConfirmation",
					//     this
					//   );
					// }
					// this.oConfirmationDialog.open();
					this.getRouter().navTo("createconf");
				},
				...
				handleNavToDoc: function (oEvent) {
