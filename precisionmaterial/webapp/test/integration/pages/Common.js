sap.ui.define([
	...
	return Opa5.extend("ui.newell.PrecisionMaterial.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["ui/newell/PrecisionMaterial/localService/mockserver"], function (mockserver) {
